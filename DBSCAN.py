...
pdf = pdf[pd.notnull(pdf["Tm"])] # delecte rows which has NaN value in "Tm" column
...
llon=-140 # minimum longitude
ulon=-50 # maximum longitude
llat=40 # minimum latitude
ulat=65 # maximum latitude
